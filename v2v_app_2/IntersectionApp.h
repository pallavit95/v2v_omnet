...
protected:
    ...
    std::vector<IntersectMessage*> yieldToRight(
            std::vector<IntersectMessage*> vehicles);
    std::vector<IntersectMessage*> yieldToRightLeftTurns(
            std::vector<IntersectMessage*> vehicles);
    std::list<const char*> getVehicleIds(
            std::vector<IntersectMessage*> vehicles);
    std::list<const char*> priorityCars(
            std::vector<IntersectMessage*> vehicles);
    ...
    //added new
    bool isInRange(Coord senderPosition, Coord receiverPosition, double range); // This line is added
