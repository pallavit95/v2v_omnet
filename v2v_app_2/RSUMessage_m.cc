...
double RSUMessage::getSenderPosX() const
{
    return this->senderPosX;
}

void RSUMessage::setSenderPosX(double senderPosX)
{
    this->senderPosX = senderPosX;
}

double RSUMessage::getSenderPosY() const
{
    return this->senderPosY;
}

void RSUMessage::setSenderPosY(double senderPosY)
{
    this->senderPosY = senderPosY;
}

double RSUMessage::getSenderPosZ() const
{
    return this->senderPosZ;
}

void RSUMessage::setSenderPosZ(double senderPosZ)
{
...
int RSUMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "senderPosX")==0) return base+1;
    if (fieldName[0]=='s' && strcmp(fieldName, "senderPosY")==0) return base+2;
    if (fieldName[0]=='s' && strcmp(fieldName, "senderPosZ")==0) return base+3;
...
std::string RSUMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return double2string(pp->getSenderPosX());
        case 2: return double2string(pp->getSenderPosY());
        case 3: return double2string(pp->getSenderPosZ());
        default: return "";
    }
}
...
bool RSUMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setSenderPosX(string2double(value)); return true;
        case 2: pp->setSenderPosY(string2double(value)); return true;
        case 3: pp->setSenderPosZ(string2double(value)); return true;
