...
/**
 * Class generated from <tt>CarMessage.msg:5</tt> by nedtool.
 * <pre>
 * message CarMessage
 * {
 *     string greeting;
...
class CarMessage : public ::omnetpp::cMessage
{
  ...
  public:
    ...
    virtual const char * getGreeting() const;
    virtual void setGreeting(const char * greeting);
