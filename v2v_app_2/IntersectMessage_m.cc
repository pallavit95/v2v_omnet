...
void IntersectMessage::copy(const IntersectMessage& other)
{
    ...
    this->senderPosX = other.senderPosX;
    this->senderPosY = other.senderPosY;
    this->senderPosZ = other.senderPosZ;
}
...
void IntersectMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->senderPosX);
    doParsimPacking(b,this->senderPosY);
    doParsimPacking(b,this->senderPosZ);
}
...
void IntersectMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->senderPosX);
    doParsimUnpacking(b,this->senderPosY);
    doParsimUnpacking(b,this->senderPosZ);
}
...
double IntersectMessage::getSenderPosX() const
{
    return this->senderPosX;
}

void IntersectMessage::setSenderPosX(double senderPosX)
{
    this->senderPosX = senderPosX;
}

double IntersectMessage::getSenderPosY() const
{
    return this->senderPosY;
}

void IntersectMessage::setSenderPosY(double senderPosY)
{
    this->senderPosY = senderPosY;
}

double IntersectMessage::getSenderPosZ() const
{
    return this->senderPosZ;
}

void IntersectMessage::setSenderPosZ(double senderPosZ)
{
    this->senderPosZ = senderPosZ;
}
...
int IntersectMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='r' && strcmp(fieldName, "roadId")==0) return base+3;
    if (fieldName[0]=='d' && strcmp(fieldName, "direction")==0) return base+4;
    if (fieldName[0]=='p' && strcmp(fieldName, "passed")==0) return base+5;
    if (fieldName[0]=='s' && strcmp(fieldName, "senderPosX")==0) return base+6;
    if (fieldName[0]=='s' && strcmp(fieldName, "senderPosY")==0) return base+7;
    if (fieldName[0]=='s' && strcmp(fieldName, "senderPosZ")==0) return base+8;
...
std::string IntersectMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return simtime2string(pp->getTimeSent());
        case 3: return oppstring2string(pp->getRoadId());
        case 4: return enum2string(pp->getDirection(), "directionType");
        case 5: return bool2string(pp->getPassed());
        case 6: return double2string(pp->getSenderPosX());
        case 7: return double2string(pp->getSenderPosY());
        case 8: return double2string(pp->getSenderPosZ());
        default: return "";
    }
}
...
bool IntersectMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setTimeSent(string2simtime(value)); return true;
        case 3: pp->setRoadId((value)); return true;
        case 4: pp->setDirection((directionType)string2enum(value, "directionType")); return true;
        case 5: pp->setPassed(string2bool(value)); return true;
        case 6: pp->setSenderPosX(string2double(value)); return true;
        case 7: pp->setSenderPosY(string2double(value)); return true;
        case 8: pp->setSenderPosZ(string2double(value)); return true;
