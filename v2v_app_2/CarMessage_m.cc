...
void CarMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->greeting);
...
const char * CarMessage::getRoadId() const
{
    return this->roadId.c_str();
}

void CarMessage::setRoadId(const char * roadId)
{
    this->roadId = roadId;
}

double CarMessage::getDistance() const
{
    return this->distance;
}

void CarMessage::setDistance(double distance)
{
...
CarMessageDescriptor::CarMessageDescriptor() : omnetpp::cClassDescriptor("CarMessage", "omnetpp::cMessage")
{
...
int CarMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='g' && strcmp(fieldName, "greeting")==0) return base+0;
    if (fieldName[0]=='c' && strcmp(fieldName, "carId")==0) return base+1;
    if (fieldName[0]=='r' && strcmp(fieldName, "roadId")==0) return base+2;
...
std::string CarMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    CarMessage *pp = (CarMessage *)object; (void)pp;
    switch (field) {
        case 0: return oppstring2string(pp->getGreeting());
        case 1: return oppstring2string(pp->getCarId());
        case 2: return oppstring2string(pp->getRoadId());
        case 3: return double2string(pp->getDistance());
        default: return "";
    }
}
...
bool CarMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    CarMessage *pp = (CarMessage *)object; (void)pp;
    switch (field) {
        case 0: pp->setGreeting((value)); return true;
        case 1: pp->setCarId((value)); return true;
        case 2: pp->setRoadId((value)); return true;
        case 3: pp->setDistance(string2double(value)); return true;
