...
{
    this->rsuPosX = other.rsuPosX;
    this->rsuPosY = other.rsuPosY;
    this->rsuPosZ = other.rsuPosZ;
}

void RSUMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::WaveShortMessage::parsimPack(b);
    doParsimPacking(b,this->rsuPosX);
    doParsimPacking(b,this->rsuPosY);
    doParsimPacking(b,this->rsuPosZ);
}

void RSUMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::WaveShortMessage::parsimUnpack(b);
    doParsimUnpacking(b,this->rsuPosX);
    doParsimUnpacking(b,this->rsuPosY);
    doParsimUnpacking(b,this->rsuPosZ);
}

double RSUMessage::getRsuPosX() const
{
    return this->rsuPosX;
}

void RSUMessage::setRsuPosX(double rsuPosX)
{
    this->rsuPosX = rsuPosX;
}

double RSUMessage::getRsuPosY() const
{
    return this->rsuPosY;
}

void RSUMessage::setRsuPosY(double rsuPosY)
{
    this->rsuPosY = rsuPosY;
}

double RSUMessage::getRsuPosZ() const
{
    return this->rsuPosZ;
}

void RSUMessage::setRsuPosZ(double rsuPosZ)
{
    this->rsuPosZ = rsuPosZ;
}
...
int RSUMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='r' && strcmp(fieldName, "rsuPosX")==0) return base+0;
    if (fieldName[0]=='r' && strcmp(fieldName, "rsuPosY")==0) return base+1;
    if (fieldName[0]=='r' && strcmp(fieldName, "rsuPosZ")==0) return base+2;
...
std::string RSUMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    RSUMessage *pp = (RSUMessage *)object; (void)pp;
    switch (field) {
        case 0: return double2string(pp->getRsuPosX());
        case 1: return double2string(pp->getRsuPosY());
        case 2: return double2string(pp->getRsuPosZ());
        default: return "";
    }
}
...
bool RSUMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    RSUMessage *pp = (RSUMessage *)object; (void)pp;
    switch (field) {
        case 0: pp->setRsuPosX(string2double(value)); return true;
        case 1: pp->setRsuPosY(string2double(value)); return true;
        case 2: pp->setRsuPosZ(string2double(value)); return true;
